...
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v2.3.0](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v2.3.0), 6 days ago) - OpenTelemetry module for Nest framework (node.js)  🔭
...
- [open-telemetry/opentelemetry-js](https://github.com/open-telemetry/opentelemetry-js) ([v0.24.0](https://github.com/open-telemetry/opentelemetry-js/releases/tag/v0.24.0), 3 weeks ago) - OpenTelemetry JavaScript Client
