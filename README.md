...
- [open-telemetry/opentelemetry-lambda](https://github.com/open-telemetry/opentelemetry-lambda) ([layer-javaagent/0.20.0](https://github.com/open-telemetry/opentelemetry-lambda/releases/tag/layer-javaagent/0.20.0), 6 days ago) - Create your own Lambda Layer in each OTel language using this starter code. Add the Lambda Layer to your Lambda Function to get tracing with OpenTelemetry.
