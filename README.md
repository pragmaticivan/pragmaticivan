...
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.16.0](https://github.com/google-github-actions/release-please-action/releases/tag/v2.16.0), 1 day ago) - automated releases based on conventional commits
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.30.0-canary.4](https://github.com/blitz-js/blitz/releases/tag/v0.30.0-canary.4), 4 days ago) - ⚡️The Fullstack React Framework — built on Next.js
