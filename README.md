...
- [external-secrets/external-secrets](https://github.com/external-secrets/external-secrets) ([helm-chart-0.19.1](https://github.com/external-secrets/external-secrets/releases/tag/helm-chart-0.19.1), 3 days ago) - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v7.0.1](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v7.0.1), 3 days ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
