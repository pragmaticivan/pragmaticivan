...
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-05.02.2024-11.44](https://github.com/newrelic/docs-website/releases/tag/release-05.02.2024-11.44), 1 day ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
- [kedacore/charts](https://github.com/kedacore/charts) ([keda-add-ons-http-v0.8.0](https://github.com/kedacore/charts/releases/tag/keda-add-ons-http-v0.8.0), 1 day ago) - Helm charts for KEDA
- [port-labs/ocean](https://github.com/port-labs/ocean) ([v0.5.17](https://github.com/port-labs/ocean/releases/tag/v0.5.17), 2 days ago) - 🌊 Ocean 🌊 is an innovative solution developed by Port to seamlessly integrate various third-party systems with our developer portal product, empowering engineers to effortlessly prioritize key features and streamline the integration process.
