...
- [open-telemetry/opentelemetry-go-contrib](https://github.com/open-telemetry/opentelemetry-go-contrib) ([v1.35.0](https://github.com/open-telemetry/opentelemetry-go-contrib/releases/tag/v1.35.0), 1 day ago) - Collection of extensions for OpenTelemetry-Go.
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v6.2.0](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v6.2.0), 5 days ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
