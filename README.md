...
- [pragmaticivan/nest-resend](https://github.com/pragmaticivan/nest-resend) ([v2.0.0](https://github.com/pragmaticivan/nest-resend/releases/tag/v2.0.0), 1 day ago) - Injectable Resend client for your nestjs projects
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-11.25.2023-15.38](https://github.com/newrelic/docs-website/releases/tag/release-11.25.2023-15.38), 2 days ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
...
- [kedacore/keda](https://github.com/kedacore/keda) ([v2.12.0](https://github.com/kedacore/keda/releases/tag/v2.12.0), 2 months ago) -  KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes 
