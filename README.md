...
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.32.0](https://github.com/google-github-actions/release-please-action/releases/tag/v2.32.0), 3 days ago) - automated releases based on conventional commits
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v2.4.0](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v2.4.0), 3 weeks ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
