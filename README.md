...
- [open-telemetry/opentelemetry-go-contrib](https://github.com/open-telemetry/opentelemetry-go-contrib) ([v1.34.0](https://github.com/open-telemetry/opentelemetry-go-contrib/releases/tag/v1.34.0), 1 week ago) - Collection of extensions for OpenTelemetry-Go.
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v6.1.2](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v6.1.2), 1 week ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
