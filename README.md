...
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-02.29.2024-13.52](https://github.com/newrelic/docs-website/releases/tag/release-02.29.2024-13.52), 1 day ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
- [kedacore/charts](https://github.com/kedacore/charts) ([v2.13.2](https://github.com/kedacore/charts/releases/tag/v2.13.2), 1 day ago) - Helm charts for KEDA
- [kedacore/keda](https://github.com/kedacore/keda) ([v2.13.1](https://github.com/kedacore/keda/releases/tag/v2.13.1), 1 day ago) -  KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes 
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.18.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.18.0), 1 day ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
