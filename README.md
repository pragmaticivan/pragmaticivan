...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.23.2-canary.3](https://github.com/blitz-js/blitz/releases/tag/v0.23.2-canary.3), 1 day ago) - ⚡️The Fullstack React Framework — built on Next.js
- [getantibody/antibody](https://github.com/getantibody/antibody) ([v6.1.1](https://github.com/getantibody/antibody/releases/tag/v6.1.1), 4 weeks ago) - The fastest shell plugin manager.
