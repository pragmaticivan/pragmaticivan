...
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.26.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.26.0), 1 day ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
