...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.30.2](https://github.com/blitz-js/blitz/releases/tag/v0.30.2), 1 day ago) - ⚡️The Fullstack React Framework — built on Next.js
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.19.2](https://github.com/google-github-actions/release-please-action/releases/tag/v2.19.2), 1 day ago) - automated releases based on conventional commits
- [pragmaticivan/mikro-orm-entity-factory](https://github.com/pragmaticivan/mikro-orm-entity-factory) ([v0.0.3](https://github.com/pragmaticivan/mikro-orm-entity-factory/releases/tag/v0.0.3), 1 day ago) - A MikroORM testing utility for bulk inserting entity objects.
