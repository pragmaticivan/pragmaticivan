...
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-05.01.2024-14.08](https://github.com/newrelic/docs-website/releases/tag/release-05.01.2024-14.08), 1 day ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
- [port-labs/ocean](https://github.com/port-labs/ocean) ([v0.5.17](https://github.com/port-labs/ocean/releases/tag/v0.5.17), 1 day ago) - 🌊 Ocean 🌊 is an innovative solution developed by Port to seamlessly integrate various third-party systems with our developer portal product, empowering engineers to effortlessly prioritize key features and streamline the integration process.
- [kedacore/charts](https://github.com/kedacore/charts) ([v2.14.1](https://github.com/kedacore/charts/releases/tag/v2.14.1), 3 days ago) - Helm charts for KEDA
