...
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-09.08.2023-13.41](https://github.com/newrelic/docs-website/releases/tag/release-09.08.2023-13.41), 3 days ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
- [port-labs/ocean](https://github.com/port-labs/ocean) ([v0.3.0](https://github.com/port-labs/ocean/releases/tag/v0.3.0), 5 days ago) - 🌊 Ocean 🌊 is an innovative solution developed by Port to seamlessly integrate various third-party systems with our developer portal product, empowering engineers to effortlessly prioritize key features and streamline the integration process.
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v5.1.5](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v5.1.5), 1 week ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
