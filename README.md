...
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.29.2](https://github.com/google-github-actions/release-please-action/releases/tag/v2.29.2), 2 days ago) - automated releases based on conventional commits
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v2.2.0](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v2.2.0), 5 days ago) - OpenTelemetry module for Nest framework (node.js)  🔭
...
- [open-telemetry/opentelemetry-js](https://github.com/open-telemetry/opentelemetry-js) ([v0.24.0](https://github.com/open-telemetry/opentelemetry-js/releases/tag/v0.24.0), 1 week ago) - OpenTelemetry JavaScript Client
