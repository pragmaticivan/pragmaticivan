...
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v6.1.1](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v6.1.1), 3 days ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
- [port-labs/ocean](https://github.com/port-labs/ocean) ([v0.5.21](https://github.com/port-labs/ocean/releases/tag/v0.5.21), 3 days ago) - 🌊 Ocean 🌊 is an innovative solution developed by Port to seamlessly integrate various third-party systems with our developer portal product, empowering engineers to effortlessly prioritize key features and streamline the integration process.
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.21.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.21.0), 6 days ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
