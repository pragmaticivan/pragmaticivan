...
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v2.4.0](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v2.4.0), 5 days ago) - OpenTelemetry module for Nest framework (node.js)  🔭
- [open-telemetry/opentelemetry-js](https://github.com/open-telemetry/opentelemetry-js) ([v0.25.0](https://github.com/open-telemetry/opentelemetry-js/releases/tag/v0.25.0), 6 days ago) - OpenTelemetry JavaScript Client
