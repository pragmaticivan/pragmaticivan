...
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-03.27.2024-15.59](https://github.com/newrelic/docs-website/releases/tag/release-03.27.2024-15.59), 1 day ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.19.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.19.0), 1 day ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
