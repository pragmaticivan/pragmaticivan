...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.35.0-canary.6](https://github.com/blitz-js/blitz/releases/tag/v0.35.0-canary.6), 1 day ago) - ⚡️The Fullstack React Framework — built on Next.js
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.28.0](https://github.com/google-github-actions/release-please-action/releases/tag/v2.28.0), 6 days ago) - automated releases based on conventional commits
