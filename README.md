...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.35.0-canary.3](https://github.com/blitz-js/blitz/releases/tag/v0.35.0-canary.3), 5 days ago) - ⚡️The Fullstack React Framework — built on Next.js
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.26.0](https://github.com/google-github-actions/release-please-action/releases/tag/v2.26.0), 5 days ago) - automated releases based on conventional commits
