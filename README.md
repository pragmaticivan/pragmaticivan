...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.28.0-canary.1](https://github.com/blitz-js/blitz/releases/tag/v0.28.0-canary.1), 1 week ago) - ⚡️The Fullstack React Framework — built on Next.js
- [getantibody/antibody](https://github.com/getantibody/antibody) ([v6.1.1](https://github.com/getantibody/antibody/releases/tag/v6.1.1), 4 months ago) - The fastest shell plugin manager.
