...
- [pragmaticivan/nestjs-otel](https://github.com/pragmaticivan/nestjs-otel) ([v2.5.0](https://github.com/pragmaticivan/nestjs-otel/releases/tag/v2.5.0), 2 days ago) - OpenTelemetry (Tracing &#43; Metrics) module for Nest framework (node.js)  🔭
- [google-github-actions/release-please-action](https://github.com/google-github-actions/release-please-action) ([v2.33.1](https://github.com/google-github-actions/release-please-action/releases/tag/v2.33.1), 4 days ago) - automated releases based on conventional commits
