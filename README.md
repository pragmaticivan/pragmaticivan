...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.27.0-canary.3](https://github.com/blitz-js/blitz/releases/tag/v0.27.0-canary.3), 2 days ago) - ⚡️The Fullstack React Framework — built on Next.js
- [getantibody/antibody](https://github.com/getantibody/antibody) ([v6.1.1](https://github.com/getantibody/antibody/releases/tag/v6.1.1), 3 months ago) - The fastest shell plugin manager.
