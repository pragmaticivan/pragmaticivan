...
- [newrelic/docs-website](https://github.com/newrelic/docs-website) ([release-02.07.2024-11.23](https://github.com/newrelic/docs-website/releases/tag/release-02.07.2024-11.23), 1 day ago) - Source code for @newrelic docs. We welcome pull requests and questions on our docs!
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.17.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.17.0), 2 days ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
